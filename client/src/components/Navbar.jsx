...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                (
                    <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:flex absolute top-10 right-0 bg-white shadow border border-gray-300 rounded-md w-40 text-sm z-40'>
            ...
            { open && (
            <div className={`${open ? 'flex' : 'hidden'} absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden z-49`}>
